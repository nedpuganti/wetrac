...
// void startTimer() {
//   _begin = new DateTime.now();
//   Duration _timerDuration = new Duration(milliseconds: 10);

//   _timer = new Timer.periodic(
//     _timerDuration,
//     (Timer timer) {
//       Duration alreadyConsumed = new DateTime.now().difference(_begin);
//       _duration = new Duration(minutes: 1);
...
//             timer = null;
//           } else {
//             int sec = remainingTime.inSeconds % 60;
//             otpWaitTimeLabel =
//                 remainingTime.inMinutes.toString() + ":" + sec.toString();
//           }
//         },
//       );
//     },
